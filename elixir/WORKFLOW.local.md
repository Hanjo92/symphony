...
agent:
  ...
  max_turns: 20
codex:
  command: "${CODEX_BIN:-codex} --config shell_environment_policy.inherit=all --config 'model=\"${CODEX_MODEL:-gpt-5.5}\"' --config model_reasoning_effort=${CODEX_REASONING_EFFORT:-high} app-server"
